...
import 'package:space_flights/home_page.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  late StreamSubscription loadingStreamSubscription;
  ...
  @override
  void initState() {
    Managemnt().articles.getArticles();
    loadingStreamSubscription = API().loadingStream.listen((value) {
      if (value) {
        showDialog(
  ...
  @override
  void dispose() {
    loadingStreamSubscription.cancel();
    super.dispose();
  }
}
